          ...
          <div className="header__right">
            <ul className="header__right-list">
              <li className="header__right-item header__right-account">
                <Link className="header__right-link" to="/Account">
                  <i className="fa-solid fa-key"></i> Account
                </Link>
              ...
              <li className="header__right-item header__right-cart">
                <span className="header__right-link">
                  <i className="fa-solid fa-cart-shopping"></i>Giỏ hàng
                  <span className="header__right-number">
                    {props.product.length}
                  </span>
                </span>
                <div className="header__cart">
                  {props.product.length > 0 ? (
                    props.product.map((n, index) => {
                      if (n.id > 0) {
                        return (
        ...
        <div className="header__below">
          <div className="header__navbar">
            <ul className="header__navbar-list">
              ...
              <li className="header__navbar-item">
                <Link className="header__navbar-link" to="/Products">
                  Product
                </Link>
              </li>
              <li className="header__navbar-item">
                <Link className="header__navbar-link" to="/Cart">
                  Cart
                </Link>
              </li>
              <li className="header__navbar-item">
              ...
              <li className="header__navbar-item">
                <Link className="header__navbar-link" to="/Notfound">
                  404
                </Link>
              </li>
            </ul>
            ...
            <div className="menu__navbar">
              <div className="menu__control">
                <ul className="menu__list" ref={navBar}>
                  ...
                  <li className="menu__item">
                    <Link className="menu__link" to="/Notfound">
                      Contact
                    </Link>
                  </li>
                  <li className="menu__item">
