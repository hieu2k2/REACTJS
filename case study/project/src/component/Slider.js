...
function Slider() {
  ...
  return (
    <div className="slider">
      <div className="slider__img">
        {image.id === 1 && (
          <img
            src={image.image}
            alt="slider"
            style={{ animation: "loadSlider 0.5s linear" }}
          ></img>
        )}
        {image.id === 2 && (
          <img
      ...
      <Link
        onClick={handleNext}
        className="slider__click-button slider__click-next"
        to=""
      >
      ...
      <Link
        onClick={handlePre}
        className="slider__click-button slider__click-pre"
        to=""
      >
      ...
      <div className="slider__button">
        <Link className="slider__button-min" to="/">
          EXPLORER
        </Link>
        <Link className="slider__button-min" to="/">
          SHOPPING NOW
