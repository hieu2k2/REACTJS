      ...
      >
        {({ errors, handleSubmit }) => (
          <form onSubmit={handleSubmit}>
            ...
            <div
              className={`custom-input ${
                errors.yearOfBirth ? "custom-input-error" : ""
              }`}
            >
              ...
              {SEX_LIST.map((item) => (
                <div key={item.value} className="flex">
                  <input
                    ...
                    id={item.value}
                    value={item.value}
                    checked={form.sex ? form.sex === item.value : false}
                    onChange={handleChange}
                  />
            ...
            <div className="custom-input flex">
              ...
              <input
                ...
                checked={form.isHaveHealthInsuranceCard || false}
                onChange={handleChange}
              />
            </div>
            ...
            <div
              className={`custom-input ${
                errors.wards ? "custom-input-error" : ""
              }`}
            >
            ...
            <div
              className={`custom-input ${
                errors.apartmentNumber ? "custom-input-error" : ""
              }`}
            >
              <label>Số nhà : </label>
              <input
            ...
            <div
              className={`custom-input ${
                errors.placesPassed ? "custom-input-error" : ""
              }`}
            >
              <label>
            ...
            <div className="custom-input flex">
              <input
                ...
                type="checkbox"
                name="isPneumonia"
                checked={form.isPneumonia || false}
                onChange={handleChange}
              />
            ...
            <div className="custom-input flex">
              <input
                ...
                type="checkbox"
                name="isSoreThroat"
                checked={form.isSoreThroat || false}
                onChange={handleChange}
              />
            ...
            <div className="custom-input flex">
              <input
                className="width-auto"
                type="checkbox"
                name="isContactWithSomeoneInfectedCovid19"
                checked={form.isContactWithSomeoneInfectedCovid19 || false}
                onChange={handleChange}
              />
            ...
            <div className="custom-input flex">
              <input
                className="width-auto"
                type="checkbox"
                name="isContactWithSomeoneFromCountriesInfectedCovid19"
                checked={
                  form.isContactWithSomeoneFromCountriesInfectedCovid19 || false
                }
                onChange={handleChange}
              />
            ...
            <div className="custom-input flex">
              <input
                className="width-auto"
                type="checkbox"
                name="isContactWithSomeoneFever"
                checked={form.isContactWithSomeoneFever || false}
                onChange={handleChange}
              />
